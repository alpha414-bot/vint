...
const Dashboard = () => {
  const { data: carts } = useCartProducts() as { data: ProductItemType[] };

  return (
    <MainLayout title="__" description="__">
      <div className="px-4 py-10 md:py-20 md:px-12">
        <div className="flex flex-col border boder-white px-3 py-5 rounded-lg justify-between gap-12 md:flex-row">
          {/* Sidebar */}
          ...
          {/* Display */}
          <div className="grow h-auto border-t border-gray-500 py-8 md:px-12 md:py-0 md:border-t-0 md:border-l">
