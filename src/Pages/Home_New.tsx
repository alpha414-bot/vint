    ...
    return (
        ...
        >
            <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-100"
            >
                {/* Hero Section */}
                <motion.section
                ...
                >
                    <div className="relative z-10 flex flex-col items-center justify-center px-4 text-center max-w-6xl mx-auto">
                        <motion.div
                            ...
                            className="mb-8"
                        >
                            <h1 className="text-5xl md:text-7xl font-black mb-6 bg-gradient-to-r from-red-600 via-red-500 to-red-700 bg-clip-text text-transparent drop-shadow-sm">
                                Pretium Concept
                            </h1>
                            <motion.p
                        ...
                        >
                            <a
                                href="#courses"
                                className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-red-600 to-red-700 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
                            >
                ...
                <motion.section
                    variants={itemVariants}
                    className="py-16 px-4 bg-gradient-to-r from-red-50 to-red-100"
                >
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            <input
                                ...
                                className="flex-1 px-6 py-4 rounded-full bg-white border-2 border-red-200 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all duration-300"
                                required
                            />
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                type="submit"
                                className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
                            >
                                Join Now
                            </motion.button>
                        </motion.form>
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="bg-gradient-to-r from-red-600 to-red-700 text-white px-4 py-2 rounded-full font-mono text-lg shadow-md">
                                        8007530
                                    </span>
                                </div>
                            ...
                            <motion.div
                                ...
                                className="mt-8"
                            >
                                <span className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-red-100 to-red-200 text-red-700 rounded-full font-semibold shadow-md">
                ...
                <motion.section
                    variants={itemVariants}
                    className="py-16 px-4 bg-gradient-to-r from-red-600 to-red-700"
                >
                    <div className="max-w-4xl mx-auto text-center">
                        <motion.div
                            initial={{ y: 30, opacity: 0 }}
